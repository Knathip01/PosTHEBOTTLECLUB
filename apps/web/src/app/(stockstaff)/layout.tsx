...
import { LogOut, Clock, Warehouse, PackagePlus, PackageSearch, ListChecks, Menu, ChevronRight } from 'lucide-react'
...
export default function StockStaffLayout({ children }: { children: React.ReactNode }) {
  ...
  const navLinks = [
    { href: '/stockstaff',              icon: Warehouse,      label: 'ภาพรวมสต็อก',    shortLabel: 'ภาพรวม' },
  ]
